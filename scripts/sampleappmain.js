...
/*{{ javascript("scripts/sampleappmain.js") }}*/
TurbulenzEngine.onload = function onloadFn() {
    ...
    var loadingLoop = function loadingLoopFn() {
        ...
        if(sceneLoader.complete()) {
            ...
            var eyePosition = mathDevice.v3Build(center[0] + extent[0] * 2 * cameraDistanceFactor, center[1] + extent[1] * cameraDistanceFactor, center[2] + extent[2] * 2 * cameraDistanceFactor);
    ...
    var gameSessionCreated = function gameSessionCreatedFn(gameSession) {
        ...
        TurbulenzServices.createMappingTable(requestHandler, gameSession, mappingTableReceived, defaultMappingSettings);
    };
