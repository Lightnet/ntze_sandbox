...
var ParticleSystem = (function () {
    ...
    ParticleSystem.create = // ParticleSystem Constructor function
    function (md, gd, parameters) {
...
var ParticleSystemRenderer = (function () {
    ...
    ParticleSystemRenderer.create = // ParticleSystemRenderer Constructor function
    function (gd, md) {
...
var Emitter = (function () {
    ...
    Emitter.create = // Emitter Constructor function
    function (gd, md, material, node, parameters) {
        var e = new Emitter();
        e.gd = gd;
        e.md = md;
