...
var HandleForces = (function () {
    ...
    HandleForces.prototype.generatePickRay = function (cameraTransform, viewWindowX, viewWindowY, aspectRatio, farPlane) {
        var md = this.md;
    ...
    HandleForces.prototype.update = function (dynamicsWorld, camera, force) {
        var md = this.md;
        //if (this.grabBody) {
    ...
    HandleForces.create = // Constructor function
    function (gd, id, md, pd, dragExtentsMin, dragExtentsMax) {
        var c = new HandleForces();

        c.md = md;
        c.pd = pd;
		console.log(pd);
        c.pickFilter = pd.FILTER_ALL;
